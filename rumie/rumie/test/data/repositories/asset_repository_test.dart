...
void main() {
  group('AssetRepositoryImpl (V8)', () {
    test(
      'upload: presign call carries bearer; PUT carries no Authorization',
      () async {
        ...
        expect(
          presignAuth,
          'Bearer tok-x',
          reason: 'presign must carry bearer',
        );
        expect(
          putAuth,
          isNull,
          reason: 'PUT must NOT carry Authorization (V8)',
        );
